#### 📌 This is used for incremental consuming the last left small amount of money quota.
...
- [ ] Modify the full screen features of Target Cards.
  - [ ] Split in two parts, the left small side is the side bar, and the full area of right side is the target cards. On the top left corner, there is a side bar switch which can hide the side bar or not.